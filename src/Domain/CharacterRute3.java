...
public class CharacterRute3 extends Character {
    ...
    public CharacterRute3(int x, int y, int imgNum) throws FileNotFoundException, IOException, InterruptedException {
        super(x, y, imgNum);
        setSprite();
        this.x = x;
        this.y = y;
    ...
    public void setSprite() throws FileNotFoundException, IOException {
        ...
        for (int i = 0; i <= 9; i++) {
            sprite.add(imageIO.read(new FileInputStream("src/Assets/SpritesSoma/" + i + ".png")));
        }
        for (int i = 0; i <= 9; i++) {
            sprite.add(imageIO.read(new FileInputStream("src/Assets/SpritesSoma/" + i + "R" + ".png")));
        }
